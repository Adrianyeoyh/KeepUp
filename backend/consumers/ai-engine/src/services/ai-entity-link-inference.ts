 ...
 *
 * Migrated from apps/worker/src/services/ai-entity-link-inference.ts.
 * Key changes:
...
async function callLLMForLinks(
...
/**
 * Run AI entity-link inference for a company.
 * Finds recent events with no entity links and uses LLM to infer connections.
 */
