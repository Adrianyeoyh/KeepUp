...
import { runInferenceEngine } from '../services/inference-engine.js';

const router = Router();

// ============================================
// POST /api/inference/run
// Runs the soft-link inference engine for the selected scope.
// ============================================
...
// ============================================
// PATCH /api/inferred-links/:id
// Confirm or dismiss an inferred link.
// ============================================
